...
*/
public class MessageCounterPerHour {
	...
	*/
	public static class Map extends MapReduceBase implements Mapper<LongWritable, Text, Text, IntWritable> {
		...
		/*
		    ...
		    e um Reporter. Perceba que o método não tem retorno, no fim do map a chave e o valor serão coletados.
		*/
		public void map(LongWritable key, Text value,
			...
			/* Separamos o id da mensagem, e convertemos o tempo da mensagem de unix para uma formatação mais visual */
			String id = parts[0];
			...
			/* A saída que será coletada será algo:
				chave: id e hora que mensagem foi enviada pelo sensor
	...
	*/
	public static class Reduce extends MapReduceBase implements
		...
		/*
		    ...
		    e um Reporter. Perceba que o método não tem retorno, no fim do reduce a chave e o valor serão coletados agora como resultado final.
		*/
		public void reduce(Text key, Iterator<IntWritable> values,
			...
			/* Como estamos interessados no número de ocorrência das mensagems dessa chave específica
			   iteramos no valor do iterator acumulando o valor, para depois coletarmos com os tipos de saída especificados na classe Reduce.
			*/
			int sum = 0;
	...
	public static void main(String[] args) throws Exception {
		...
		JobConf conf = new JobConf(MessageCounterPerHour.class);
